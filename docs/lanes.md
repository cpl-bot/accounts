...
| dashboard-real-values | opencode | openai/gpt-5.6-luna | `workspace:E2DEBE1C-A779-452D-9862-CAD8D3B638BB` | `/Users/admin/Documents/accounts-wt/dashboard-real-values` | `scripts/validate_db_sync.py`, focused script tests, this board card | in progress |
