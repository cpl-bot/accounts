...
|---|---|---|---|---|---|---|
| reject-tally-protocol-errors | opencode | opencode-go/qwen3.7-plus | `ses_f70c962eeffePotf6TqRh38qwT` | `/Users/admin/Documents/accounts-wt/reject-tally-protocol-errors` | `middleware/talai_middleware/tally/{parsers,client,fake}.py`, focused middleware tests | active |
